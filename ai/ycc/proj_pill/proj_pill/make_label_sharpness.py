...
def make_label_sharpness(args):
    ...
    list_pills_label_path_sharp_score += [ [label, pathname, score_mean, score_min, score_max] for label, ( pathname, score_mean, score_min, score_max ) in enumerate(list_pills_sharp_score)]
